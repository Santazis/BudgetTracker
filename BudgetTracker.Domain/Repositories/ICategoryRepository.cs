...
public interface ICategoryRepository
{
    ...
    Task<List<Category>> GetByUserIdAsync(Guid userId,CancellationToken cancellation);
    Task<Category?> GetByIdAsync(Guid id,Guid userId,CancellationToken cancellation);
    Task<int> CountUserCategoriesAsync(Guid userId,CancellationToken cancellation);
